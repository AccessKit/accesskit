...
pub(crate) mod tree;
pub use tree::{ChangeHandler as TreeChangeHandler, Tree, TreeState, Update as TreeUpdate};
...
#[cfg(test)]
mod tests {
    use accesskit::{Affine, NodeId, Rect, Role, TreeInfo, TreeUpdate, Vec2};
    ...
    pub fn build_test_tree(update: &mut crate::TreeUpdate) {
        ...
        update.set_tree(TreeInfo::new(ROOT_ID));
