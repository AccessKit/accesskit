...
use accesskit::{
    ActionHandler, ActivationHandler, DeactivationHandler, Node, NodeId, Role, Tree, TreeId,
};
...
impl Adapter {
    ...
    pub fn update_if_active(&mut self, _tree_id: TreeId, _fill: impl FnOnce(&mut TreeUpdate)) {}
