    ...
    fn role(&self) -> AtspiRole {
        self.0.map(|node| {
            match node.role() {
                ...
                Role::DocBackLink | Role::DocBiblioRef | Role::DocGlossRef | Role::DocNoteRef =>  AtspiRole::Link,
                ...
                Role::DocAcknowledgements | Role::DocAfterword | Role::DocAppendix | Role::DocBibliography | Role::DocChapter | Role::DocConclusion | Role::DocCredits | Role::DocEndnotes | Role::DocEpilogue | Role::DocErrata | Role::DocForeword | Role::DocGlossary | Role::DocIndex | Role::DocIntroduction | Role::DocPageList | Role::DocPart | Role::DocPreface | Role::DocPrologue | Role::DocToc => AtspiRole::Landmark,
                Role::DocAbstract | Role::DocColophon | Role::DocCredit | Role::DocDedication | Role::DocEpigraph | Role::DocExample | Role::DocPullquote | Role::DocQna => AtspiRole::Section,
                ...
                Role::GenericContainer | Role::FooterAsNonLandmark | Role::HeaderAsNonLandmark | Role::Ruby => AtspiRole::Section,
                ...
                Role::PopupButton => {
                    if node.data().html_tag.as_ref().map_or(false, |tag| tag.as_ref() == "select") {
                        AtspiRole::ComboBox
                    } else {
                ...
                Role::Abbr | Role::Code | Role::Emphasis | Role::Strong | Role::Time => AtspiRole::Static,
