...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_accesskit_mac_AccessKitMacManager_nativeNewForNSWindow(
    env: JNIEnv,
    _class: JClass,
    window_ptr: jlong,
...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_accesskit_mac_AccessKitMacManager_nativeNewForNSView(
    env: JNIEnv,
    _class: JClass,
    view_ptr: jlong,
    initial_state_json: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_accesskit_mac_AccessKitMacManager_nativeDestroy(
    _env: JNIEnv,
    _class: JClass,
    ptr: jlong,
) {
    let _boxed_manager = Box::from_raw(ptr as *mut Manager);
    // Let the box drop at the end of the scope.
}

#[no_mangle]
pub unsafe extern "system" fn Java_dev_accesskit_mac_AccessKitMacManager_nativeUpdate(
    env: JNIEnv,
    _class: JClass,
    ptr: jlong,
    update_json: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_dev_accesskit_mac_AccessKitMacManager_nativeInject(
    _env: JNIEnv,
    _class: JClass,
    ptr: jlong,
) {
